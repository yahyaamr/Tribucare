...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    title: "TribuCare Events & News — Congresses, Training & Launches",
    description:
        ...
        <div className="max-w-3xl">
          ...
          <Reveal delay={280}>
            <p className="mt-4 text-lg leading-relaxed text-ink-soft">
              Congresses, hands-on training days, brand launches and regional
              exhibitions — the calendar behind the education and support our
              partners rely on.
            </p>
          </Reveal>
        </div>
