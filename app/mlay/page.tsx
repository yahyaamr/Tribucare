...
import { MlayProductCard } from "@/components/mlay/mlay-product-card";
import {
  mlay,
  mlayProductLines,
  mlayCategoriesFor,
...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    title: "MLAY Egypt — Home Beauty Technology | TribuCare",
    description:
...
export default function MlayPage() {
  return (
    <>
      {/* ---- Hero ------------------------------------------------------- */}
        ...
        <Shell className="relative z-10 pt-30 pb-24 md:pt-36 md:pb-32 lg:pt-44">
          ...
          <Reveal delay={340}>
            <div className="mt-16 border-t border-white/10 pt-8">
              <p className="eyebrow text-brand-300">Official Brand Partner</p>
      ...
      <section id="catalogue" className="ground-light relative py-24 md:py-32">
        <Shell>
          ...
          <div className="mt-16 space-y-20 md:mt-24 md:space-y-24">
            {mlayProductLines.map((line, lineIndex) => (
              <div key={line.id}>
                <Reveal>
                ...
                {mlayCategoriesFor(line.id).map((group, groupIndex) => (
                    ...
                    <ul className="mt-6 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                      {group.items.map((product, i) => (
                        <Reveal
                          ...
                          className="h-full"
                        >
                          <MlayProductCard product={product} />
                        </Reveal>
                      ))}
                    </ul>
                  </div>
      ...
      <section className="ground-deep relative isolate overflow-hidden py-24 md:py-32">
        ...
        <Shell className="relative">
          ...
          <div className="mt-16">
            ...
            <Rail aria-label={mlay.retail.eyebrow} className="mt-8 gap-5 pb-4">
