...
export function Newsletter() {
  ...
  return (
    <Reveal delay={200} className="mt-20" from="scale">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-brand-900 via-brand-800 to-brand-950 p-8 text-white shadow-2xl sm:p-12">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -right-16 -bottom-16 size-80 rounded-full bg-signal-500/10 blur-3xl"
        />
        ...
        <div className="relative z-10 grid gap-8 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-2 font-display text-2xl font-semibold text-white sm:text-3xl">
              Stay updated with clinical &amp; beauty tech insights
            </h2>
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-brand-100/80 sm:text-base">
              Quarterly dermatological whitepapers, brand launch announcements
              and medical training schedules, straight to your inbox.
            </p>
          </div>
