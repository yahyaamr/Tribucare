...
const ui = {
  ...
  blog: {
    ...
    categoryMetaTitle: "{category} — المدونة والمقالات",
    categoryMetaDescription:
      "{category}: رؤى إكلينيكية وابتكارات في التركيبات وتطوّرات في الأجهزة وتحليلات للسوق من الفريق الاستشاري الطبي في تريبوكير.",
  ...
  pages: {
    ...
    imageOpen: "عرض الصورة بالحجم الكامل",
    imageClose: "إغلاق",
  ...
  pageMeta: {
    ...
    events: {
      ...
      tagTitle: "{tag} — الفعاليات والأخبار",
      tagDescription:
        "{tag}: مؤتمرات وأيام تدريب عملي وإطلاق علامات ومعارض إقليمية من تريبوكير.",
    },
    partner: {
      title: "كن شريكًا لنا",
      description:
